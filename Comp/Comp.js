...
export default class Comp extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("New Piskel", "./Comp/costumes/New Piskel.png", {
        x: 17,
        y: 35,
      }),
      new Costume("New Piskel copy", "./Comp/costumes/New Piskel copy.png", {
        x: 22,
        y: 26,
      }),
      new Costume("New Piskel copy2", "./Comp/costumes/New Piskel copy2.png", {
        x: 31,
        y: 22,
      }),
    ];
