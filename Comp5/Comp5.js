...
export default class Comp5 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("New Piskel", "./Comp5/costumes/New Piskel.png", {
        x: 17,
        y: 35,
      }),
      new Costume("New Piskel copy", "./Comp5/costumes/New Piskel copy.png", {
        x: 22,
        y: 26,
      }),
      new Costume("New Piskel copy2", "./Comp5/costumes/New Piskel copy2.png", {
        x: 18,
        y: 31,
      }),
    ];
