...
export default class Comp2 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("New Piskel", "./Comp2/costumes/New Piskel.png", {
        x: 17,
        y: 35,
      }),
      new Costume("New Piskel copy", "./Comp2/costumes/New Piskel copy.png", {
        x: 22,
        y: 26,
      }),
      new Costume("New Piskel copy2", "./Comp2/costumes/New Piskel copy2.png", {
        x: 20,
        y: 16,
      }),
    ];
  ...
  *whenGreenFlagClicked3() {
    ...
    while (true) {
      this.direction = this.radToScratch(
        Math.atan2(
          this.sprites["Comp"].y - this.y,
          this.sprites["Comp"].x - this.x
        )
      );
      yield;
    }
